//#region src/locales/ru/tamagotchi/settings.yaml
var data = {
	...
	"pages": {
		...
		"system": {
			"sections": { "section": { "window-shortcuts": { "title": "Клавиши навигации окна" } } },
			"window-shortcuts": {
				"description": "Редактирование горячих клавиш для управления окном",
				"title": "Горячие клавиши управления окном",
				"toggle-move": { "label": "Перемещение окна" },
				"toggle-resize": { "label": "Масштабирование окна" },
				"toggle-ignore-mouse-event": { "label": "Игнорировать курсор мыши" },
	...
	"devtools": {
		...
		"pages": {
			...
			"lag-visualizer": { "title": "Lag Visualizer" },
			...
			"widgets-calling": { "title": "Widget Calling" }
		}
	},
