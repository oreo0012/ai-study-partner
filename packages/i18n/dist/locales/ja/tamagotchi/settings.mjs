//#region src/locales/ja/tamagotchi/settings.yaml
var data = {
	...
	"pages": {
		...
		"system": {
			"sections": { "section": { "window-shortcuts": { "title": "キーボードショートカット" } } },
			"window-shortcuts": {
				"description": "ウィンドウ用ショートカットを変更します。",
				"title": "ウィンドウショートカット",
				"toggle-move": { "label": "移動の切り替え" },
				"toggle-resize": { "label": "サイズ変更の切り替え" },
				"toggle-ignore-mouse-event": { "label": "マウスイベント無視の切り替え" },
	...
	"devtools": {
		"title": "開発者",
		"pages": {
			"context-flow": { "title": "コンテキストのフロー" },
			"lag-visualizer": { "title": "ラグビジュアライザー" },
			...
			"widgets-calling": { "title": "ウィジェット呼び出し" }
		}
	},
