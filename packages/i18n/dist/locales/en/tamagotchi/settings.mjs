//#region src/locales/en/tamagotchi/settings.yaml
var data = {
	...
	"pages": {
		...
		"system": {
			"sections": { "section": { "window-shortcuts": { "title": "Keyboard Shortcuts" } } },
			"window-shortcuts": {
				"description": "Modify the window shortcuts.",
				"title": "Window Shortcuts",
				"toggle-move": { "label": "Toggle Move" },
				"toggle-resize": { "label": "Toggle Resize" },
				"toggle-ignore-mouse-event": { "label": "Toggle Ignore Mouse Event" },
